...
module.exports = function (_, opts) {
  ...
  if (opts.globals) {
    brOpts.globals = opts.globals;
  }

  if (opts.rewriteMap) {
    brOpts.rewriteMap = opts.rewriteMap;
  }

  if (Array.isArray(opts.transform)) {
    brOpts.transform = opts.transform;
  }
  ...
  if (opts.use) {
    [].concat(opts.use).forEach(function (u) {
      b.use(resolve.sync(u, {
        basedir: process.cwd()
      }));
    });
  }
